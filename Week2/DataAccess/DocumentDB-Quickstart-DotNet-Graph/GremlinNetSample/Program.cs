...
namespace GremlinNetSample
{
    ...
    class Program
    {
        ...
        private static string hostname = "vc0330.gremlin.cosmosdb.azure.com";
        private static int port = 443;
        private static string authKey = "n657l6GwVEy8XP8hzTHZFNR1UfEbUn1OGcyGkkOMbeE6CzAu2bsDZGnmrqxXLLAxDM64gUII6chAO8dB7rXGyg==";
        ...
        private static Dictionary<string, string> gremlinQueries = new Dictionary<string, string>
        {
            ...
            { "AddVertex 5",    "g.addV('vehicle').property('id', 'someVIN').property('make', 'Kia').property('model', 'ev6').property('firstName','Eric')" },
            { "AddEdge 1",      "g.V('thomas').addE('knows').to(g.V('mary'))" },
            { "AddEdge 2",      "g.V('thomas').addE('knows').to(g.V('ben'))" },
            { "AddEdge 3",      "g.V('ben').addE('knows').to(g.V('robin'))" },
            { "AddEdge 4",      "g.V('ben').addE('teaches').to(g.V('robin'))" },
            { "AddEdge 5",      "g.V('robin').addE('attends').to(g.V('ben'))" },
            { "AddEdge 6",      "g.V('robin').addE('drives').to(g.V('someVIN'))" },
            { "UpdateVertex",   "g.V('thomas').property('age', 44).property('profession','IT')" },
